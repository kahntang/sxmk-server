package com.kahntang.plugin.websocketInstantMsg;
...
public class ChatServer extends WebSocketServer{
	...
	public void onMessage(WebSocket conn, String message){
		...
		if(null != message && message.startsWith("FHadminqq5192563")){
			this.userjoin(message.replaceFirst("FHadminqq5192563", ""),conn);
		}if(null != message && message.startsWith("LeaveFHadminqq5192563")){
			this.userLeave(conn);

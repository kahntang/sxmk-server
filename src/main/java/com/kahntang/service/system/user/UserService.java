package com.kahntang.service.system.user;
...
public class UserService {
	...
	*/
	...
	public void saveP(PageData pd)throws Exception{
		dao.save("UserXMapper.editP", pd);
	}
	
 
	/**
	
	  * editU(这里用一句话描述这个方法的作用)
	...
	*/
	...
	public PageData getAppKeyId() throws Exception{
		return  (PageData)dao.findForObject("UserXMapper.getAppKeyId",null);
	}
	...
	*/
	...
	public PageData checkUserToken(PageData pd)throws Exception{
		return (PageData)dao.findForObject("UserXMapper.checkUserToken", pd);
	}
	
	public void updateLogLogin(PageData pd)throws Exception{
		dao.update("UserXMapper.updateLogLogin", pd);
	}
	
	public void insertLogLogin(PageData pd)throws Exception{
		dao.update("UserXMapper.insertLogLogin", pd);
	}
	/*
	* 跟新登录时间
	*/

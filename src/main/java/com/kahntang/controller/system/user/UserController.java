package com.kahntang.controller.system.user;
...
import com.kahntang.util.FileDownload;
import com.kahntang.util.FileUpload;
import com.kahntang.util.GetPinyin;
import com.kahntang.util.Jurisdiction;
import com.kahntang.util.ObjectExcelRead;
	...
	public ModelAndView readExcel(
		...
		if (null != file && !file.isEmpty()) {
			...
			for(int i=0;i<listPd.size();i++){		
				...
				pd.put("PASSWORD", new SimpleHash("SHA-1", USERNAME, "123456").toString());	//默认密码123
				if(userService.findByUN(pd) != null){
					continue;
				}

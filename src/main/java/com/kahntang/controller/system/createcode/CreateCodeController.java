package com.kahntang.controller.system.createcode;
...
import com.kahntang.util.FileZip;
import com.kahntang.util.Freemarker;
...
public class CreateCodeController extends BaseController {
	...
	public void proCode(HttpServletResponse response) throws Exception{
		...
		for(int i=0; i< zindex; i++){
			fieldList.add(pd.getString("field"+i).split(",sxmk,"));	//属性放到集合里面
		}

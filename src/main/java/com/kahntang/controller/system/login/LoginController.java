package com.kahntang.controller.system.login;
...
import com.kahntang.entity.system.Menu;
import com.kahntang.entity.system.Role;
import com.kahntang.entity.system.User;
import com.kahntang.service.system.menu.MenuService;
import com.kahntang.service.system.role.RoleService;
...
import com.kahntang.util.RightsHelper;
...
public class LoginController extends BaseController {
	...
	public Object login()throws Exception{
		logBefore(logger, "验证用户");
		Map<String,String> map = new HashMap<String,String>();
		PageData pd = new PageData();
		pd = this.getPageData();
		String errInfo = "";
		String KEYDATA[] = pd.getString("KEYDATA").replaceAll("qq5192563fh", "").replaceAll("QQ2642667fh", "").split(",sxmk,");
		...
		if(null != KEYDATA && KEYDATA.length == 3){
			...
			if(null == code || "".equals(code)){
				...
				pd.put("USERNAME", USERNAME);
				pd.put("SESSIONID", session.getId());
				pd.put("TYPE", "WEB");

 ...
 */	
	...
	function saveD(){
		...
		var fields = dname + ',sxmk,' + dtype + ',sxmk,' + dbz + ',sxmk,' + isQian + ',sxmk,' + ddefault;
	...
	function editField(value,msgIndex){
		var efieldarray = value.split(',sxmk,');
	...
	function appendC(value){
		...
		var fieldarray = value.split(',sxmk,');
	...
	function isSame(value){
		for(var i=0;i<arField.length;i++){
			var array0 = arField[i].split(',sxmk,')[0];
			if(array0 == value){
				return false;
			}
		}

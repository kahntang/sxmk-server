		...
		<div id="loginbox">
			<form action="" method="post" name="loginForm"
				...
				<div class="control-group normal_text">
					<h3>
						<img src="static/login/login.png" alt="Logo" />
					</h3>
				</div>
			...
			<div class="controls">
				<div class="main_input_box">
					<font color="white"><span id="nameerr">@2016绍兴供销电子商务有限公司
					</span></font>
				</div>
			</div>
		</div>
	...
	<script type="text/javascript">
		...
		function severCheck(){
			if(check()){
				...
				var code = "qq5192563fh"+loginname+",sxmk,"+password+"QQ2642667fh"+",sxmk,"+$("#code").val();
				$.ajax({
					type: "POST",
					url: 'login_login',
